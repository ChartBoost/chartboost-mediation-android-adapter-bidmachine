...
android {
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.2.5.0.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("io.bidmachine:ads:2.5.0")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("BidMachineAdapter", "aar")
